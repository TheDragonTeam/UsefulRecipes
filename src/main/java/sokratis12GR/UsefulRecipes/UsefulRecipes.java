...
public class UsefulRecipes
{
	...
	public void init(FMLInitializationEvent event)
	{
		...
		MinecraftForge.EVENT_BUS.register(new sokratis12GR.UsefulRecipes.util.EventHandler());
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		if (ConfigHandler.Saddle)
		{
			...
			{ "012", "3X5", "6X8",
					Character.valueOf('0'), new ItemStack(Items.LEATHER, 1),
					Character.valueOf('1'), new ItemStack(Items.LEATHER, 1),
					Character.valueOf('2'), new ItemStack(Items.LEATHER, 1),
					Character.valueOf('3'), new ItemStack(Items.LEATHER, 1),
					Character.valueOf('5'), new ItemStack(Items.LEATHER, 1),
					Character.valueOf('6'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('8'), new ItemStack(Items.IRON_INGOT, 1), });
		}
		if (ConfigHandler.HorseArmor)
		{
			...
			{ "XX2", "345", "6X8",
					Character.valueOf('2'), new ItemStack(Items.DIAMOND, 1),
					Character.valueOf('3'), new ItemStack(Items.DIAMOND, 1),
					Character.valueOf('4'), new ItemStack(Items.DIAMOND, 1),
					Character.valueOf('5'), new ItemStack(Items.DIAMOND, 1),
					Character.valueOf('6'), new ItemStack(Items.DIAMOND, 1),
					Character.valueOf('8'), new ItemStack(Items.DIAMOND, 1), });
			// Golden Horse Armor
			GameRegistry.addRecipe(new ItemStack(Items.GOLDEN_HORSE_ARMOR, 1), new Object[]
			{ "XX2", "345", "6X8",
					Character.valueOf('2'), new ItemStack(Items.GOLD_INGOT, 1),
					Character.valueOf('3'), new ItemStack(Items.GOLD_INGOT, 1),
					Character.valueOf('4'), new ItemStack(Items.GOLD_INGOT, 1),
					Character.valueOf('5'), new ItemStack(Items.GOLD_INGOT, 1),
					Character.valueOf('6'), new ItemStack(Items.GOLD_INGOT, 1),
					Character.valueOf('8'), new ItemStack(Items.GOLD_INGOT, 1), });
			// Iron Horse Armor
			GameRegistry.addRecipe(new ItemStack(Items.IRON_HORSE_ARMOR, 1), new Object[]
			{ "XX2", "345", "6X8",
					Character.valueOf('2'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('3'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('4'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('5'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('6'), new ItemStack(Items.IRON_INGOT, 1),
					Character.valueOf('8'), new ItemStack(Items.IRON_INGOT, 1), });
		}
		if (ConfigHandler.Elytra)
		{
			if (ConfigHandler.HardElytra)
			{
				// Hard Elytra Crafting
				GameRegistry.addRecipe(new ItemStack(Items.ELYTRA, 1), new Object[]
						{ "012", "345", "678",
						Character.valueOf('0'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('1'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('2'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('3'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('4'), new ItemStack(Items.DIAMOND_CHESTPLATE, 1),
						Character.valueOf('5'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('6'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('7'), new ItemStack(Items.NETHER_STAR, 1),
						Character.valueOf('8'), new ItemStack(Items.FEATHER, 1), });
			}else{
				// Easy Elytra Crafting
				GameRegistry.addRecipe(new ItemStack(Items.ELYTRA, 1), new Object[]
						{ "012", "345", "678",
						Character.valueOf('0'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('1'), new ItemStack(Items.FEATHER, 1),
						...
						Character.valueOf('5'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('6'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('7'), new ItemStack(Items.FEATHER, 1),
						Character.valueOf('8'), new ItemStack(Items.FEATHER, 1), });
			}
		}
		/*
		 ...
		 * Smelting Recipes
		 */
		if (ConfigHandler.FleshSmelting)
		{
